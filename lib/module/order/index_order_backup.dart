      ...
      body: SingleChildScrollView(
        child: Container(
          padding: EdgeInsets.symmetric(
            vertical: Sz.hpfactor(context, 45),
            horizontal: MediaQuery.of(context).size.width > 1200
                ? Sz.wpfactor(context, 100)
                : Sz.wpfactor(context, 50),
          ),
          child: FormBuilder(
            key: _formKey,
            child: Row(
                ...
                Expanded(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Sz.title(context, 'Nama Pemesan / Orderer Name',
                      ...
                      SpaceVertical(size: 20),
                      Sz.title(context, 'Kota / City', TextAlign.left,
                          Palette.blackClr),
                      SpaceVertical(size: 5),
                      FormBuilderTextField(
                        name: 'city',
                  ...
                  child: Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SpaceVertical(size: 20),
                        Sz.title(
                            context, 'Total', TextAlign.left, Palette.blackClr),
                        SpaceVertical(size: 5),
                        ...
                        Sz.title(
                            context,
                            'Total Harus di Bayar / Total Must Be Paid',
                            TextAlign.left,
                            Palette.blackClr),
                        SpaceVertical(size: 5),
                        Consumer<OrderProvider>(
